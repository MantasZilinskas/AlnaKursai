...
namespace TodoApp.ClientsAndProjects.Api.Controllers
{
    ...
    public class ProjectsController : ControllerBase
    {
        ...
        public ProjectsController(ClientProjectApiContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Projects
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ProjectDAO>>> GetProjects()
        {
        ...
        // GET: api/Projects/5
        [HttpGet("{id}")]
        public async Task<ActionResult<ProjectDAO>> GetProject(int id)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<ProjectDAO>> DeleteProject(int id)
        {
            var project = await _context.Projects.FindAsync(id);
            if (project == null)
            {
